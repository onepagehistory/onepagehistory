    ...
    return (
        <div className="EventPage">
            ...
            <div className="Share-box">
                ...
                <a className="twitter-share-button" target="_blank" href={`https://twitter.com/intent/tweet?text=Look+what+I+found+out+here&url=https%3A%2F%2Fstg1.worldhistory.page%2Fp%2F${ entry.name }`}>
